...
func handleNewProject(projectName string, templateRepo string, templateDir string, templateBranch string) {
	...
	if err := cloneAndReplaceProject(projectMeta.ModulePath, source, useLocalDir, templateBranch); err != nil {
...
func updateProject(projectName string, templateRepo string, templateDir string, templateBranch string) {
	...
	if err := updateProjectFromTemplate(projectDir, projectName, source, useLocalDir, templateBranch); err != nil {
